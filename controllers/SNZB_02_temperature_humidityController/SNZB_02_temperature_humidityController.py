...
from SHDevices.SONOFF.sh_SNZB_02_temperature_humidity import *
...
sh_device = SH_SNZB_02_temperature_humidity(robot.getName(), connection=connection, device=robot)
sh_device.connect()
