...
from SHDevices.sh_simtime import *
...
sh_device = SH_SimTime(robot.getName(), connection=connection, device=robot,  hour=simtime.get('hour'), minute=simtime.get('minute'), second=simtime.get('second'))
sh_device.connect()
